...
public class Test2 {
    ...
    public void test1() {
        ...
        Runnable r = new Runnable() {
            @Override
            public void run() {
                System.out.println("Num by anonymous = " + num);
            }
        };
        r.run();

        System.out.println("===============================");
        Runnable r1 = () -> System.out.println("num by lambda: " + num);
        r1.run();
    }
    ...
    public void test2() {
        ...
        con.accept("Hello, this is from test2 use lambda");
    }
    ...
    @Test
    public void test6() {
        Integer num1 = operation(100, x -> x + 100);
